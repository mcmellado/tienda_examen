...
<body>
    ...
    <form method="GET" action="">
        <p>
        <label>
            <input type="hidden" name="_testigo" value="hola">
            <button type="submit" class="focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-4 py-2 dark:bg-green-600 dark:hover:bg-blue-700 dark:focus:ring-blue-900">En stock </button>
        </label>
        </p>
    </form>
        </fieldset>
